...
from transpdf.cache import TranslationCache
        ...
        return [
            {
                "role": "user",
                "content": (
                    f"你是一位专业的{self.lang_in}到{self.lang_out}翻译专家，专门从事学术论文和技术文档的翻译。
...
"
                    "### 2. 母语化表达
"
                    f"- 使用{self.lang_out}的自然表达方式，避免生硬的直译
"
                    f"- 句式应符合{self.lang_out}的语法习惯和表达习惯
"
                    "- 用词应准确、专业、地道
"
                    "- 避免'翻译腔'，让译文读起来像母语者写的
